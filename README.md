...
`abundant-rabbit`. Below the width a table needs, each plan prints as a
short record with every field kept; `--columns` (or `PENTIMENTO_COLUMNS`)
chooses which columns show and in what order — see
