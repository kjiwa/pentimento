...
Cursor's rules and caveats are in
[docs/integrations.md](https://github.com/kjiwa/pentimento/blob/main/docs/integrations.md#cursor).
...
[matching rule](https://github.com/kjiwa/pentimento/blob/main/docs/integrations.md#cursor)
